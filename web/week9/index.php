...
/*
form that allows a user to specify 1) the weight of the item and then 2) select one of the following types of mail:
...
-----------------------------------------
a page that displays the information they submitted along with the resulting price.
-----------------------------------------
